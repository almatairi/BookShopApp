...
public class DataHolder {
    ...
    public void init(){
        ...
        books.add(new Book("0", "Prilli i thyer", "Fiction", 2003, authors));
        books.add(new Book("1", "1984", "Novel", 1949, authors));
        books.add(new Book("2", "To Kill a Mockingbird", "Novel", 1962, authors));
        books.add(new Book("3", "Girl with a pearl earring", "Novel", 1999, authors));
        books.add(new Book("4", "Discpilining the soul", "Religion", 2021, authors));
    }
}

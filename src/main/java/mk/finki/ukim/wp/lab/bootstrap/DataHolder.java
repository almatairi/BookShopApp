...
public class DataHolder {
    ...
    public void init(){
        ...
        if(authorRepository.count() == 0){
            authors.add(new Author(01L, "Ismail", "Kadare", "Ismail Kadare, (born January 28, 1936, Gjirokastër, Albania), Albanian novelist and poet whose work explored his country’s history and culture and gained an international readership.","28-01-1936"));
        ...
        if(bookRepository.count() == 0){
            ...
            books.add(new Book("01", "Prilli thyer", "Fiction", 1999, authorList.get(0), bookStoreList.get(0)));
            books.add(new Book("02", "Nga jeta ne  jete, PSE?", "Fiction", 1999, authorList.get(0), bookStoreList.get(0)));
            books.add(new Book("03", "Vepra poetike", "Poem", 1999, authorList.get(0), bookStoreList.get(0)));
            books.add(new Book("04", "Te fshehtat e treguara", "Fiction", 1999, authorList.get(0), bookStoreList.get(0)));
            books.add(new Book("05", "The adriatic review", "Fiction", 1999, authorList.get(0), bookStoreList.get(0)));
